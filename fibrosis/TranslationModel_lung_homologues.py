...
pre_local_d = torch.load('pre_models/local_d_homologues_6.pth')
pre_classifier = torch.load('pre_models/classifier_disease_homologues_6.pth')
pre_species_classifier = torch.load('pre_models/species_classifier_homologues_%s.pt'% fold)
pre_cell_classifier = torch.load('pre_models/classifier_cell_homologues_6.pth')
pre_adverse_classifier = torch.load('pre_models/classifier_adverse_homologues_%s.pt'% fold)
pre_cell_adverse_classifier = torch.load('pre_models/classifier_cell_adverse_homologues_%s.pt'% fold)
pre_Vsp = torch.load('pre_models/Vspecies_homologues_%s.pt'% fold)
pre_Vcell = torch.load('pre_models/Vcell_homologues_%s.pt'% fold)

for fold in range(begin_fold,model_params['no_folds']):
    #pre_encoder_human = torch.load('pre_models/encoder_human_homologues_%s.pth'% fold)
    #pre_encoder_mouse = torch.load('pre_models/encoder_mouse_homologues_%s.pth'% fold)
    #pre_prior_d = torch.load('pre_models/prior_d_homologues_%s.pth'% fold)
    #pre_local_d = torch.load('pre_models/local_d_homologues_%s.pth'% fold)
    #pre_classifier = torch.load('pre_models/classifier_disease_homologues_%s.pth'% fold)
    #pre_species_classifier = torch.load('pre_models/species_classifier_homologues_%s.pt'% fold)
    #pre_cell_classifier = torch.load('pre_models/classifier_cell_homologues_%s.pth'% fold)
    #pre_adverse_classifier = torch.load('pre_models/classifier_adverse_homologues_%s.pt'% fold)
    #pre_cell_adverse_classifier = torch.load('pre_models/classifier_cell_adverse_homologues_%s.pt'% fold)
    #pre_Vsp = torch.load('pre_models/Vspecies_homologues_%s.pt'% fold)
    #pre_Vcell = torch.load('pre_models/Vcell_homologues_%s.pt'% fold)
    ...
    torch.save(encoder_human,'models/encoder_human_homologues_%s.pth'%fold)
    torch.save(encoder_mouse,'models/encoder_mouse_homologues_%s.pth'%fold)
    torch.save(decoder_human, 'models/decoder_human_homologues_%s.pth' % fold)
    torch.save(decoder_mouse, 'models/decoder_mouse_homologues_%s.pth' % fold)
    torch.save(prior_d,'models/prior_d_homologues_%s.pth'%fold)
    torch.save(local_d,'models/local_d_homologues_%s.pth'%fold)
    torch.save(classifier,'models/classifier_disease_homologues_%s.pth'%fold)
    torch.save(Vsp,'models/Vspecies_homologues_%s.pt'%fold)
    torch.save(Vcell,'models/Vcell_homologues_%s.pt'%fold)
    torch.save(adverse_classifier,'models/classifier_adverse_homologues_%s.pt'%fold)
    torch.save(cell_adverse_classifier,'models/classifier_cell_adverse_homologues_%s.pt'%fold)
    torch.save(cell_classifier, 'models/classifier_cell_homologues_%s.pth' % fold)
    torch.save(species_classifier,'models/species_classifier_homologues_%s.pt'%fold)
    ...
    valEmbs_human.to_csv('results/embs/validation/valEmbs_%s_human_homologues.csv'%fold)
    valEmbs_mouse.to_csv('results/embs/validation/valEmbs_%s_mouse_homologues.csv'%fold)
    ...
    valEmbs_base_human.to_csv('results/embs/validation/valEmbs_base_%s_human_homologues.csv'%fold)
    valEmbs_base_mouse.to_csv('results/embs/validation/valEmbs_base_%s_mouse_homologues.csv'%fold)
    ...
    trainEmbs_human.to_csv('results/embs/train/trainEmbs_%s_human_homologues.csv'%fold)
    trainEmbs_mouse.to_csv('results/embs/train/trainEmbs_%s_mouse_homologues.csv'%fold)
    ...
    trainEmbs_base_human.to_csv('results/embs/train/trainEmbs_base_%s_human_homologues.csv'%fold)
    trainEmbs_base_mouse.to_csv('results/embs/train/trainEmbs_base_%s_mouse_homologues.csv'%fold)
    ...
    results.to_csv('results/10foldvalidationResults_lungs_homologues.csv')
print2log(results)

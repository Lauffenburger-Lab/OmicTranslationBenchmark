...
for fold in range(folds):
    ...
    # Load trained models
    encoder_human = torch.load('human lung fibrosis/models2/encoder_human_%s.pth'%fold)
    encoder_mouse = torch.load('human lung fibrosis/models2/encoder_mouse_%s.pth'%fold)
    decoder_human = torch.load('human lung fibrosis/models2/decoder_human_%s.pth' % fold)
    decoder_mouse = torch.load('human lung fibrosis/models2/decoder_mouse_%s.pth' % fold)
    Vsp = torch.load('human lung fibrosis/models2/Vspecies_%s.pt'%fold)
    Vcell = torch.load('human lung fibrosis/models2/Vcell_%s.pt'%fold)
    ...
    valPreds_reconstructed_human.to_csv('human lung fibrosis/preds/validation/valPreds_reconstructed_%s_human.csv' % fold)
    valPreds_reconstructed_mouse.to_csv('human lung fibrosis/preds/validation/valPreds_reconstructed_%s_mouse.csv' % fold)
    ...
    valPreds_translated_human.to_csv('human lung fibrosis/preds/validation/valPreds_translated_%s_tohuman.csv' % fold)
    valPreds_translated_mouse.to_csv('human lung fibrosis/preds/validation/valPreds_translated_%s_tomouse.csv' % fold)
    ...
    results.to_csv('human lung fibrosis/10foldvalidationResults_lungs_perCellType.csv')
print2log(results)

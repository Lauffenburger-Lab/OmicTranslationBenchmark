...
#             print2log(outString)
#     print2log(outString)
#     torch.save(decoder_2, '../results/ANNmixedTransCompR_results/pretrained_models/decoder_ht29_%s.pt' % i)
#
...
#             print2log(outString)
#     print2log(outString)
#     torch.save(decoder_1, '../results/ANNmixedTransCompR_results/pretrained_models/decoder_a375_%s.pt' % i)
#
# print2log('Evaluate translation using decoders')
# for i in range(model_params["no_folds"]):
#     decoder_1 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/decoder_a375_%s.pt' % i)
#     decoder_2 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/decoder_ht29_%s.pt' % i)
#     trainInfo_paired = pd.read_csv('../preprocessing/preprocessed_data/10fold_validation_spit/train_paired_%s.csv' % i, index_col=0)
#     trainInfo_1 = pd.read_csv('../preprocessing/preprocessed_data/10fold_validation_spit/train_a375_%s.csv' % i, index_col=0)
#     trainInfo_2 = pd.read_csv('../preprocessing/preprocessed_data/10fold_validation_spit/train_ht29_%s.csv' % i, index_col=0)
...
# df_result.to_csv('../results/ANNmixedTransCompR_results/'+gene_space+'_10foldvalidation_pretrained_decoders_1000ep512bs_a375_ht29.csv')
...
for i in range(model_params["no_folds"]):
    # Network
    encoder_2 = SimpleEncoder(nComps2, model_params['encoder_2_hiddens'], gene_size,
    ...
    for e in range(0, NUM_EPOCHS):
        ...
        if (e % 200 == 0):
            print2log(outString)
    print2log(outString)
    torch.save(encoder_2, '../results/ANNmixedTransCompR_results/pretrained_models/encoder_ht29_%s.pt' % i)

print2log('Train encoder for cell-line 1')
for i in range(model_params["no_folds"]):
    # Network
    encoder_1 = SimpleEncoder(nComps1, model_params['encoder_1_hiddens'], gene_size,
                        dropRate=model_params['dropout_encoder'],
                        activation=model_params['encoder_activation']).to(device)
    ...
    for e in range(0, NUM_EPOCHS):
        ...
        if (e % 200 == 0):
            print2log(outString)
    print2log(outString)
    torch.save(encoder_1, '../results/ANNmixedTransCompR_results/pretrained_models/encoder_a375_%s.pt' % i)

print2log('Evaluate translation using encoders')
for i in range(model_params["no_folds"]):
    encoder_1 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/encoder_a375_%s.pt' % i)
    encoder_2 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/encoder_ht29_%s.pt' % i)
    trainInfo_paired = pd.read_csv('../preprocessing/preprocessed_data/10fold_validation_spit/train_paired_%s.csv' % i,
                                   index_col=0)
    trainInfo_1 = pd.read_csv('../preprocessing/preprocessed_data/10fold_validation_spit/train_a375_%s.csv' % i,
                              index_col=0)
    ...
    xhat_2 = encoder_2(x1_transformed)
    xhat_1 = encoder_1(x2_transformed)
...
df_result = pd.DataFrame({'recon_pear_ht29':valPear_2 ,'recon_pear_a375':valPear_1,
                          'recon_spear_ht29':valSpear_2 ,'recon_spear_a375':valSpear_1,
                          'recon_acc_ht29':valAccuracy_2 ,'recon_acc_a375':valAccuracy_1})
df_result.to_csv('../results/ANNmixedTransCompR_results/'+gene_space+'_10foldvalidation_pretrained_encoders_1000ep512bs_a375_ht29.csv')
...
for i in range(model_params["no_folds"]):
    # Network
    pre_encoder_1 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/encoder_a375_%s.pt'%i)
    pre_encoder_2 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/encoder_ht29_%s.pt' % i)
    pre_decoder_1 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/decoder_a375_%s.pt' % i)
    pre_decoder_2 = torch.load('../results/ANNmixedTransCompR_results/pretrained_models/decoder_ht29_%s.pt' % i)
    ...
    # pretrained_adv_class = torch.load('../results/ANNmixedTransCompR_results/pre_models/pre_trained_classifier_adverse_1.pt')
    ...
    torch.save(decoder_1, '../results/ANNmixedTransCompR_results/models/decoder_a375_%s.pt' % i)
    torch.save(decoder_2, '../results/ANNmixedTransCompR_results/models/decoder_ht29_%s.pt' % i)
    torch.save(prior_d, '../results/ANNmixedTransCompR_results/models/priorDiscr_%s.pt' % i)
    torch.save(local_d, '../results/ANNmixedTransCompR_results/models/localDiscr_%s.pt' % i)
    torch.save(encoder_1, '../results/ANNmixedTransCompR_results/models/encoder_a375_%s.pt' % i)
    torch.save(encoder_2, '../results/ANNmixedTransCompR_results/models/encoder_ht29_%s.pt' % i)
    # torch.save(classifier, '../results/ANNmixedTransCompR_results/models/classifier_%s.pt' % i)
    # torch.save(Vsp, '../results/ANNmixedTransCompR_results/models/Vspecies_%s.pt' % i)
    # torch.save(adverse_classifier, '../results/ANNmixedTransCompR_results/models/classifier_adverse_%s.pt' % i)
...
df_result.to_csv('../results/ANNmixedTransCompR_results/'+gene_space+'_10foldvalidation_ANNmixedTransCompR_500ep512bs_a375_ht29.csv')
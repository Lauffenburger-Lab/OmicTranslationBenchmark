...
for fold_id,folder in enumerate(folders):
    ...
    # Network
        ...
        trainInfo_paired = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/train_paired_%s.csv'%i,index_col=0)
        trainInfo_1 = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/train_A375_%s.csv'%i,index_col=0)
        trainInfo_2 = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/train_HT29_%s.csv'%i,index_col=0)

        valInfo_paired = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/val_paired_%s.csv'%i,index_col=0)
        valInfo_1 = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/val_A375_%s.csv'%i,index_col=0)
        valInfo_2 = pd.read_csv('sampledDatasetes/A375_HT29/'+folder+'/val_HT29_%s.csv'%i,index_col=0)
        ...
        torch.save(decoder_1,'sampledDatasetes/A375_HT29/'+folder+'/decoder_1_%s.pt'%i)
        torch.save(decoder_2,'sampledDatasetes/A375_HT29/'+folder+'/decoder_2_%s.pt'%i)
        torch.save(prior_d,'sampledDatasetes/A375_HT29/'+folder+'/priorDiscr_%s.pt'%i)
        torch.save(local_d,'sampledDatasetes/A375_HT29/'+folder+'/localDiscr_%s.pt'%i)
        torch.save(encoder_1,'sampledDatasetes/A375_HT29/'+folder+'/encoder_1_%s.pt'%i)
        torch.save(encoder_2,'sampledDatasetes/A375_HT29/'+folder+'/encoder_2_%s.pt'%i)
        torch.save(classifier,'sampledDatasetes/A375_HT29/'+folder+'/classifier_%s.pt'%i)
        torch.save(Vsp,'sampledDatasetes/A375_HT29/'+folder+'/Vspecies_%s.pt'%i)
        torch.save(adverse_classifier,'sampledDatasetes/A375_HT29/'+folder+'/classifier_adverse_%s.pt'%i)
    ...
    df_result.to_csv('sampledDatasetes/A375_HT29/'+folder+'.csv')